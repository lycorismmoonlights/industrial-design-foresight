...
export const sources = sqliteTable(
  "sources",
  {
    ...
    adapterType: text("adapter_type").notNull().default("rss"),
    adapterConfigJson: text("adapter_config_json").notNull().default("{}"),
    cadence: text("cadence").notNull().default("daily"),
    nextFetchAt: text("next_fetch_at"),
    maxItemsPerRun: integer("max_items_per_run").notNull().default(30),
...
export const pipelineRuns = sqliteTable(
  "pipeline_runs",
  {
    ...
    aiProcessedCount: integer("ai_processed_count").notNull().default(0),
    aiFailureCount: integer("ai_failure_count").notNull().default(0),
    error: text("error"),
